...
[^Cram_Net]: Jyh-Jing Hwang, Henrik Kretzschmar, Joshua Manela, Sean Rafferty, Nicholas Armstrong-Crews, Tiffany Chen, Dragomir Anguelov, ["CramNet: Camera-Radar Fusion with Ray-Constrained Cross-Attention for Robust 3D Object Detection"](https://waymo.com/research/cramnet-camera-radar-fusion-with-ray-constrained-cross-attention-for-robust/), arXiv, 2022
